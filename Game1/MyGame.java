...
public class MyGame
{
    static void AI(String AIanswer){                                            
        ...
        //String[] sentance ={"You're guilty! Go to Jail for 3 years! Your friend is free", "You both are guilty, both go to prison for 2 years"};
